...
public class FastMob extends Enemy {
    ...
    FastMob(
        ...
        Image walkSheet = new Image(
            getClass().getResourceAsStream("/assets/fastmob.png")
        );

        Image deathSheet = new Image(
            getClass().getResourceAsStream("/assets/fastmob_die.png")
        );

        walkAnimator = new SpriteAnimator(walkSheet, 150, 150, 4, 11, 8);
